...
//     version 1.7.0
//     from Assets/Resources/Input/Player Input Map.inputactions
//
...
public partial class @PlayerInputMap: IInputActionCollection2, IDisposable
{
    ...
    public struct CharacterBaseModeActions
    {
        ...
        public CharacterBaseModeActions(@PlayerInputMap wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @PlayerInputMap m_Wrapper;
        public CharacterStealthModeActions(@PlayerInputMap wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @PlayerInputMap m_Wrapper;
        public CharacterBattleModeActions(@PlayerInputMap wrapper) { m_Wrapper = wrapper; }
